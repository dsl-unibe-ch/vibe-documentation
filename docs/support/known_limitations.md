...
## `lmod` currently unavailable on VIBE
...
## Clipboard not functional in some browsers
...
**We recommend to use the Chrome browser** for the best experience using the VIBE desktop.