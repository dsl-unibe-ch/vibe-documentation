...
- On the VIBE system configuration form, select 1 hour time limit, Partition: gpu-invest, GPU type: RTX-4090 and instance size: Large. Optionally, click email on start. Click the button "Launch" and wait for your session to start.
